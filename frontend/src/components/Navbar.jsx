    ...
    <nav className={`${styles.paddingX}} w-full flex items-center py-5 fixed top-0 z-20 bg-primary`}>
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-white text-[18px] font-bold cursor-pointer flex">Matthew &nbsp;
        ...
        <div className="sm:hidden flex flex-1 justify-end items-center"> {/* Mobile Menu */}
        <img src={toggle ? close : menu} alt="menu" className="w-[28px] h-[28px] object-contain cursor-pointer" 
        onClick={() => setToggle(!toggle)} />
        <div className={`${!toggle ? 'hidden' : 'flex'} 
        p-6 black-gradient absolute top-20
        my-2 min-w-[140px] z-10 rounded-xl`}> {/* Mobile Menu Dropdown*/}
        {/*Similar UL to what we have in our Navbar*/}
